...
Estudiante de **Lic. en Nutrición** y desarrollador web en formación.  
Me apasiona tratar cualquier tema con rigor académico y explorar la tecnología como una ciencia.  

---

## 📌 Sobre mí
- 🔭 Actualmente estoy aprendiendo **Django, JavaScript y algo de Linux**.  
- 🌱 Me interesa el desarrollo web, la ciencia de datos y la creación de contenido visual.  
- 🎨 También disfruto trabajar con **Blender** y **Photoshop** para proyectos creativos.  
